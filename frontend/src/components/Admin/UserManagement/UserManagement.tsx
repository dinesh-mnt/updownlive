                ...
                <CardContent className="p-0">
                    <div className="overflow-x-auto">
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    <TableHead className="px-8 py-4 font-bold text-white text-base  ">Subscriber</TableHead>
                                    <TableHead className="px-6 py-4 font-bold text-white text-base ">Email Identity</TableHead>
                                    <TableHead className="px-6 py-4 font-bold text-white text-base ">Authority</TableHead>
                                    <TableHead className="px-6 py-4 font-bold text-white text-base ">Verification Status</TableHead>
                                    <TableHead className="px-8 py-4 font-bold text-white text-base ">Actions</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {users.length === 0 ? (
